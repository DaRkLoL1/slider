...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js?!./src/index.scss":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??ref--6-2!./node_modules/resolve-url-loader!./node_modules/sass-loader/dist/cjs.js??ref--6-4!./src/index.scss ***!
  \*****************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(jQuery) {/* harmony import */ var _MainModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MainModel */ "./src/MainModel.ts");
...
/* harmony import */ var _ModelHandle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ModelHandle */ "./src/ModelHandle.ts");
    ...
    $.fn.myPlugin = function (method) {
        let methods = {
            init: function (that, params) {
                ...
                that.data('model', new _MainModel__WEBPACK_IMPORTED_MODULE_0__["MainModel"]({ min: options.min, max: options.max, step: options.step, handle: new _ModelHandle__WEBPACK_IMPORTED_MODULE_3__["ModelHandle"](options.value) }));
                that.data('view', new _View__WEBPACK_IMPORTED_MODULE_1__["View"](that));
...
/* harmony import */ var _ViewScale__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ViewScale */ "./src/ViewScale.ts");
    ...
    createSlider(obj) {
        ...
        if (typeof width === 'number') {
            ...
            if (this.position === 'vertical') {
                ...
                this.thumb = new _ViewThumb__WEBPACK_IMPORTED_MODULE_0__["ViewThumb"](this.item.find('.slider__thumb_vertical'), this.item.find('.slider__line_vertical'));
            }
            else {
                $(this.item).find('.slider__field').html('<div class="slider__line"></div><div class="slider__thumb"></div>');
                this.thumb = new _ViewThumb__WEBPACK_IMPORTED_MODULE_0__["ViewThumb"](this.item.find('.slider__thumb'), this.item.find('.slider__line'));
            }
            ...
            if (obj.tooltip) {
                if (this.position === 'vertical') {
                    ...
                    this.tooltip = new _ViewTooltip__WEBPACK_IMPORTED_MODULE_1__["ViewTooltip"](this.item.find('.slider__tooltip_vertical'));
                }
                else {
                    $(this.item).find('.slider__field').prepend($('<div class="slider__tooltip"></div>'));
                    this.tooltip = new _ViewTooltip__WEBPACK_IMPORTED_MODULE_1__["ViewTooltip"](this.item.find('.slider__tooltip'));
                }
            ...
            if (obj.interval) {
                if (this.position === 'vertical') {
                    ...
                    this.scale = new _ViewScale__WEBPACK_IMPORTED_MODULE_2__["ViewScale"](this.item.find('.slider__numbers_vertical'));
                }
                else {
                    $(this.item).find('.slider').append($('<div class="slider__numbers"></div>'));
                    this.scale = new _ViewScale__WEBPACK_IMPORTED_MODULE_2__["ViewScale"](this.item.find('.slider__numbers'));
                }
...
/*!**************************!*\
  !*** ./src/ViewScale.ts ***!
  \**************************/
/*! exports provided: ViewScale */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewScale", function() { return ViewScale; });
class ViewScale {
    constructor(scale) {
        this.scale = scale;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.scss */ "./src/index.scss");
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Slider_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Slider.ts */ "./src/Slider.ts");
...
$('.configure__button').on('click', function (event) {
    ...
    $(parent.parent().children()[0]).myPlugin(obj);
});
...
$('.root-input').val($('.root-slider').myPlugin('value'));
$('.root-input').on('change', function (event) {
    let target = $(event.currentTarget);
    $('.root-slider').myPlugin('value', target.val());
});
$('.root-slider1').myPlugin({
    slide: function (num) {
        $('.root-input1').val(num);
    }
});
$('.root-input1').val($('.root-slider1').myPlugin('value'));
$('.root-input1').on('change', function (event) {
    let target = $(event.currentTarget);
    $('.root-slider1').myPlugin('value', target.val());
});
$('.root-slider2').myPlugin({
    slide: function (num) {
        $('.root-input2').val(num);
    }
});
$('.root-input2').val($('.root-slider2').myPlugin('value'));
$('.root-input2').on('change', function (event) {
    let target = $(event.currentTarget);
    $('.root-slider2').myPlugin('value', target.val());
});
$('.root-slider3').myPlugin({
    slide: function (num) {
        $('.root-input3').val(num);
    }
});
$('.root-input3').val($('.root-slider3').myPlugin('value'));
$('.root-input3').on('change', function (event) {
    let target = $(event.currentTarget);
    $('.root-slider3').myPlugin('value', target.val());
});
