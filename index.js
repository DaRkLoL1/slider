...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js?!./src/Slider.scss":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??ref--6-2!./node_modules/resolve-url-loader!./node_modules/sass-loader/dist/cjs.js??ref--6-4!./src/Slider.scss ***!
  \******************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js?!./src/range-slider/range-slider.scss":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??ref--6-2!./node_modules/resolve-url-loader!./node_modules/sass-loader/dist/cjs.js??ref--6-4!./src/range-slider/range-slider.scss ***!
  \*************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var map = {
	...
	"./ModelHandle.ts": "./src/ModelHandle.ts",
	"./Prezenter.ts": "./src/Prezenter.ts",
	"./Slider.scss": "./src/Slider.scss",
	"./Slider.ts": "./src/Slider.ts",
	"./View.ts": "./src/View.ts",
	"./ViewThumb.ts": "./src/ViewThumb.ts",
	"./ViewTooltip.ts": "./src/ViewTooltip.ts",
	"./index.ts": "./src/index.ts",
	"./range-slider/range-slider-init.ts": "./src/range-slider/range-slider-init.ts",
	"./range-slider/range-slider.scss": "./src/range-slider/range-slider.scss",
	"./range-slider/range-slider.ts": "./src/range-slider/range-slider.ts"
};
...
webpackContext.id = "./src sync recursive \\.scss|ts$";
...
class Model {
    ...
    increaseValue(i) {
        ...
        if (this.handle.length > 1) {
            const rightHandle = this.handle[i + 1];
            if (!rightHandle) {
    ...
    reduceValue(i) {
        if (this.handle.length > 1) {
            if (i === 0) {
                ...
                const leftHandle = this.handle[i - 1];
    ...
    addObserverModelControler(o) {
        this.observer = o;
    }
    notifyObserverModelControler() {
...
/*!****************************!*\
  !*** ./src/ModelHandle.ts ***!
  \****************************/
/*! exports provided: ModelHandle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModelHandle", function() { return ModelHandle; });
class ModelHandle {
    constructor(value) {
        this.value = value;
    }
...
/*!**************************!*\
  !*** ./src/Prezenter.ts ***!
  \**************************/
/*! exports provided: Prezenter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Prezenter", function() { return Prezenter; });
class Prezenter {
...
var content = __webpack_require__(/*! !../node_modules/mini-css-extract-plugin/dist/loader.js!../node_modules/css-loader/dist/cjs.js??ref--6-2!../node_modules/resolve-url-loader!../node_modules/sass-loader/dist/cjs.js??ref--6-4!./Slider.scss */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js?!./src/Slider.scss");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(jQuery) {/* harmony import */ var _Model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Model */ "./src/Model.ts");
/* harmony import */ var _ModelHandle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ModelHandle */ "./src/ModelHandle.ts");
/* harmony import */ var _Prezenter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Prezenter */ "./src/Prezenter.ts");
    ...
    $.fn.myPlugin = function (method) {
        const methods = {
            init(that, params) {
                ...
                if (options.range) {
                    for (let i = 0; i < 2; i += 1) {
                        handle.push(new _ModelHandle__WEBPACK_IMPORTED_MODULE_1__["ModelHandle"](options.value[i]));
                    }
                }
                else {
                    handle.push(new _ModelHandle__WEBPACK_IMPORTED_MODULE_1__["ModelHandle"](options.value[0]));
                }
                ...
                that.data('model', new _Model__WEBPACK_IMPORTED_MODULE_0__["Model"]({
                    handle,
                    max: options.max,
                    min: options.min,
                    step: options.step,
                }));
                that.data('view', new _View__WEBPACK_IMPORTED_MODULE_3__["View"](that));
                that.data('prazenter', new _Prezenter__WEBPACK_IMPORTED_MODULE_2__["Prezenter"](that.data('view'), that.data('model')));
...
/* harmony import */ var _ViewThumb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ViewThumb */ "./src/ViewThumb.ts");
/* harmony import */ var _ViewTooltip__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ViewTooltip */ "./src/ViewTooltip.ts");
...
class View {
        ...
        if (typeof width === 'number') {
            ...
            for (let i = 0; i < index; i += 1) {
                if (this.position === 'vertical') {
                    ...
                    this.thumb[i] = new _ViewThumb__WEBPACK_IMPORTED_MODULE_0__["ViewThumb"]($(this.item.find('.slider__thumb_vertical')[i]));
                }
                else {
                    $(this.item).find('.slider__field')
                        .append('<div class="slider__thumb"></div>');
                    this.thumb[i] = new _ViewThumb__WEBPACK_IMPORTED_MODULE_0__["ViewThumb"]($(this.item.find('.slider__thumb')[i]));
                }
            ...
            if (obj.tooltip) {
                ...
                for (let i = 0; i < index; i += 1) {
                    if (this.position === 'vertical') {
                        ...
                        this.tooltip[i] = new _ViewTooltip__WEBPACK_IMPORTED_MODULE_1__["ViewTooltip"]($(this.item.find('.slider__tooltip_vertical')[i]));
                    }
                    else {
                        $(this.item).find('.slider__field').append($('<div class="slider__tooltip"></div>'));
                        this.tooltip[i] = new _ViewTooltip__WEBPACK_IMPORTED_MODULE_1__["ViewTooltip"]($(this.item.find('.slider__tooltip')[i]));
                    }
    ...
    addObserverViewControler(o) {
        this.observer = o;
    }
    notifyObserverViewControler() {
        if (typeof this.observer !== 'undefined') {
...
/*!**************************!*\
  !*** ./src/ViewThumb.ts ***!
  \**************************/
/*! exports provided: ViewThumb */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewThumb", function() { return ViewThumb; });
class ViewThumb {
    constructor(thumb) {
        this.thumb = thumb;
        this.symbol = '';
    }
    installValue(value, interval) {
...
class ViewTooltip {
    ...
    setTooltip(position, value) {
        ...
        if (typeof width === 'number') {
            const left = position - width / 2 + 'px';
            if (this.tooltip.hasClass('slider__tooltip_vertical')) {
...
importAll(__webpack_require__("./src sync recursive \\.scss|ts$"));


/***/ }),

/***/ "./src/range-slider/range-slider-init.ts":
/*!***********************************************!*\
  !*** ./src/range-slider/range-slider-init.ts ***!
  \***********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _range_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./range-slider */ "./src/range-slider/range-slider.ts");

const slider = document.querySelectorAll('.js-range-slider');
if (slider) {
    slider.forEach((val) => {
        new _range_slider__WEBPACK_IMPORTED_MODULE_0__["RangeSlider"]($(val));
    });
}
...
var content = __webpack_require__(/*! !../../node_modules/mini-css-extract-plugin/dist/loader.js!../../node_modules/css-loader/dist/cjs.js??ref--6-2!../../node_modules/resolve-url-loader!../../node_modules/sass-loader/dist/cjs.js??ref--6-4!./range-slider.scss */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js?!./src/range-slider/range-slider.scss");
...
/***/ "./src/range-slider/range-slider.ts":
/*!******************************************!*\
  !*** ./src/range-slider/range-slider.ts ***!
  \******************************************/
...
class RangeSlider {
    ...
    createSlider() {
        if (this.$slider) {
            this.options = this.$slider.myPlugin(this.options).data('options');
        }
        this.initPanel();
    }
    initPanel() {
    ...
    handleValueChange() {
        if (this.$startValue && this.$endValue) {
            ...
            if (typeof startValue === 'string' && typeof endValue2 === 'string') {
                this.$slider.myPlugin('value', [Number.parseInt(startValue, 10), Number.parseInt(endValue2, 10)]);
            }
        }
    }
    updateValueInOptions() {
        if (this.$startValue && this.$endValue) {
            const startValue = this.$startValue.val();
            const endValue2 = this.$endValue.val();
            if (typeof startValue === 'string' && typeof endValue2 === 'string') {
